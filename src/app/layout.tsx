...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${dancingScript.className} ${cinzel.className} ${comfortaa.className} ${inter.className} antialiased`}
      >
        {/* Navigation */}
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">My Home Luxury Girl&apos;s Hostel</h3>
                <p className="text-gray-400">
                  Where Comfort Meets Class - A premium girls&apos; hostel designed with elegance, safety, and convenience at its heart.
                </p>
              </div>
              <div>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; {new Date().getFullYear()} My Home Luxury Girl&apos;s Hostel. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
